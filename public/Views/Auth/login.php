...
<body id="auth-page" class="flex-row-center-center">
    <div class="flex-column-center-center auth-panel">
        <h1 class="flex-row-center-center">SIGN IN</h1>
        <form class="flex-column-center-center" action="login" method="POST">
            ...
            <button type="submit" class="flex-row-center-center">Sign In</button>
        </form>
        <p class="auth-subtext">Don't have an account? <a href="register">Sign Up</a></p>
    </div>
